...
import { getAiCodePerSession, updateSession } from "../../supabase/supabase.service";
import { createNewCodePrompt, refactorCodePrompt, useChooseFile } from "../codeCompletion.prompts";
...
import {addSystemMessage, handleParsingCreatedCode} from "../codeCompletion.service";
...
export async function handleExistingFileUpdate(
  ...
  const functionality = classification.functionality
    ...
    if (!file_name || !file_path) {
        ...
        console.log("No file name or path provided, asking user to choose file", functionality);
...
export async function handleScratchPadUpdate(messages: any[], classification: { functionality: any; location: any; }, user: any, sessionId: any, location: any): Promise<CodeCompletionResponse>{
