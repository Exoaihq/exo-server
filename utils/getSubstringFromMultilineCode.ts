...
export function getSubstringFromMultilineCode(lines: Array<string>, startRow: number, startCol: number, endRow: number, endCol: number) {
    let result = '';
    ...
    if (numberOfRows < 1) {
        ...
        return startPosition + result + endPosition
    }
}
